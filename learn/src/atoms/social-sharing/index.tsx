...
const SocialSharing = ({ title, link }) => {
  return (
    <div
      className="flex flex-column-l items-center content-center justify-start absolute-l"
      style={{
        left: '-60px',
        top: '100px',
      }}
    >
      <h5 className="f6 black-60 mr3 mv0 mr0-l mb3-l lh-solid">Share</h5>
      <a
        href={`https://facebook.com/sharer/sharer.php?u=${link}`}
        target="_blank"
        className="dib w1 h1  mr3 mr0-l mb2-l"
      >
        <div className="w-100">
