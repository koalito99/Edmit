...
import { SignupSubmitButton } from '../../../../../client/src/testIds/ids';
...
interface IOnboardingCardProps<FormFields> {
  ...
  onContinue?: (formikProps: FormikProps<FormFields>) => PromiseLike<void | null> | void | null;
  continueText?: string;
  ...
  isMobile?: boolean;
  children?: React.ComponentType<{ children: JSX.Element }>;
}
        ...
        render={formikProps => {
          ...
          return (
              ...
              style={{
                ...
                opacity:
                  this.props.visibleState === ESteppedWizardStepVisibleState.NOT_YET_OPENED ||
                    ...
                    : 1
                ,
                transition: 'left 500ms cubic-bezier(.59, .01, .16, 1), opacity 500ms',
                zIndex:
                  this.props.visibleState === ESteppedWizardStepVisibleState.NOT_YET_OPENED ||
                    this.props.visibleState === ESteppedWizardStepVisibleState.OPENED
                    ? 0
            ...
            >
              ...
              />
              {this.props.visibleState !== ESteppedWizardStepVisibleState.NOT_YET_OPENED && <div className="pa3 pa4-ns">
                {this.props.heading && (
                  <div className={'tc'}>
